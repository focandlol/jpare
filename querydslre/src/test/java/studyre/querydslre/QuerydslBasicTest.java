...
import studyre.querydslre.dto.MemberDto;
import studyre.querydslre.dto.QMemberDto;
import studyre.querydslre.dto.UserDto;
import studyre.querydslre.entity.Member;
import studyre.querydslre.entity.QMember;
import studyre.querydslre.entity.QTeam;
...
public class QuerydslBasicTest {
    ...
    public void findDtoByJpql(){
        List<MemberDto> result = em.createQuery("select new studyre.querydslre.dto.MemberDto(m.username,m.age) from Member m",
    ...
    private List<Member> searchMember1(String usernameCond, Integer ageCond) {
        ...
        if(usernameCond != null){
            builder.or(member.username.eq(usernameCond));
        }
    ...
    public void bulkUpdate(){
        long count = queryFactory
                .update(member)
                .set(member.username, member.username + "비회원")
